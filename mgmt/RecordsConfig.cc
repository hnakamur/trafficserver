...
static const RecordElement RecordsConfig[] =
{
  ...
  ,
  {RECT_CONFIG, "proxy.config.http.header_field_max_size", RECD_INT, "65535", RECU_DYNAMIC, RR_NULL, RECC_INT, "[0-65535]", RECA_NULL}
  ,
  //        ############
  //        # security #
  //        ############
...
,
  ...
  ,
  {RECT_CONFIG, "proxy.config.http2.default_buffer_water_mark", RECD_INT, "32768", RECU_DYNAMIC, RR_NULL, RECC_STR, "^[0-9]+$", RECA_NULL}
  ,
