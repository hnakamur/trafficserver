...
static const std::unordered_map<std::string_view, prom_metric_info> prom_metric_info_map = {
  ...
  {"proxy.process.cache.frags_per_doc.3+", {"proxy_process_cache_frags_per_doc_3plus", COUNTER, nullptr}}, // + -> plus
  ...
  {"proxy.process.hostdb.insert_duplicate_to_pending_dns", {"proxy_process_hostdb_insert_duplicate_to_pending_dns", COUNTER, nullptr}},
  ...
  {"proxy.process.net.per_client.connections_throttled_in", {"proxy_process_net_per_client_connections_throttled_in", COUNTER, nullptr}},
  {"proxy.process.net.connections_throttled_out", {"proxy_process_net_connections_throttled_out", COUNTER, nullptr}},
  {"proxy.process.tunnel.total_client_connections_blind_tcp", {"proxy_process_tunnel_total_client_connections_blind_tcp", COUNTER, nullptr}},
  {"proxy.process.tunnel.current_client_connections_blind_tcp", {"proxy_process_tunnel_current_client_connections_blind_tcp", GAUGE, nullptr}},
  {"proxy.process.tunnel.total_server_connections_blind_tcp", {"proxy_process_tunnel_total_server_connections_blind_tcp", COUNTER, nullptr}},
  {"proxy.process.tunnel.current_server_connections_blind_tcp", {"proxy_process_tunnel_current_server_connections_blind_tcp", GAUGE, nullptr}},
  {"proxy.process.tunnel.total_client_connections_tls_tunnel", {"proxy_process_tunnel_total_client_connections_tls_tunnel", COUNTER, nullptr}},
  {"proxy.process.tunnel.current_client_connections_tls_tunnel", {"proxy_process_tunnel_current_client_connections_tls_tunnel", GAUGE, nullptr}},
  {"proxy.process.tunnel.total_client_connections_tls_forward", {"proxy_process_tunnel_total_client_connections_tls_forward", COUNTER, nullptr}},
  {"proxy.process.tunnel.current_client_connections_tls_forward", {"proxy_process_tunnel_current_client_connections_tls_forward", GAUGE, nullptr}},
  {"proxy.process.tunnel.total_client_connections_tls_partial_blind", {"proxy_process_tunnel_total_client_connections_tls_partial_blind", COUNTER, nullptr}},
  {"proxy.process.tunnel.current_client_connections_tls_partial_blind", {"proxy_process_tunnel_current_client_connections_tls_partial_blind", GAUGE, nullptr}},
  {"proxy.process.tunnel.total_client_connections_tls_http", {"proxy_process_tunnel_total_client_connections_tls_http", COUNTER, nullptr}},
  {"proxy.process.tunnel.current_client_connections_tls_http", {"proxy_process_tunnel_current_client_connections_tls_http", GAUGE, nullptr}},
  ...
  {"proxy.process.net.default_inactivity_timeout_applied", {"proxy_process_net_default_inactivity_timeout_applied", COUNTER, nullptr}},
  ...
  {"proxy.process.net.inactivity_cop_lock_acquire_failure", {"proxy_process_net_inactivity_cop_lock_acquire_failure", COUNTER, nullptr}},
  {"proxy.process.net.dynamic_keep_alive_timeout_in_count", {"proxy_process_net_dynamic_keep_alive_timeout_in_count", COUNTER, nullptr}},
  {"proxy.process.net.dynamic_keep_alive_timeout_in_total", {"proxy_process_net_dynamic_keep_alive_timeout_in_total", COUNTER, nullptr}},
  ...
  {"proxy.process.ssl.ssl_session_cache_lock_contention", {"proxy_process_ssl_ssl_session_cache_lock_contention", COUNTER, nullptr}},
  ...
  {"proxy.process.ssl.total_attempts_handshake_count_in", {"proxy_process_ssl_total_attempts_handshake_count_in", COUNTER, nullptr}},
  {"proxy.process.ssl.total_attempts_handshake_count_out", {"proxy_process_ssl_total_attempts_handshake_count_out", COUNTER, nullptr}},
  ...
  {"proxy.process.ssl.total_success_handshake_count_out", {"proxy_process_ssl_total_success_handshake_count_out", COUNTER, nullptr}},
  ...
  {"proxy.process.http.milestone.cache_open_write_begin", {"proxy_process_http_milestone_cache_open_write_begin", COUNTER, nullptr}},
  ...
  {"proxy.process.http.current_active_client_connections", {"proxy_process_http_current_active_client_connections", GAUGE, nullptr}},
  ...
  {"proxy.process.http.err_client_abort_origin_server_bytes", {"proxy_process_http_err_client_abort_origin_server_bytes", COUNTER, nullptr}},
  {"proxy.process.http.err_client_abort_user_agent_bytes", {"proxy_process_http_err_client_abort_user_agent_bytes", COUNTER, nullptr}},
  {"proxy.process.http.err_client_read_error_count", {"proxy_process_http_err_client_read_error_count", COUNTER, nullptr}},
  {"proxy.process.http.err_client_read_error_origin_server_bytes", {"proxy_process_http_err_client_read_error_origin_server_bytes", COUNTER, nullptr}},
  {"proxy.process.http.err_client_read_error_user_agent_bytes", {"proxy_process_http_err_client_read_error_user_agent_bytes", COUNTER, nullptr}},
  {"proxy.process.http.err_connect_fail_count", {"proxy_process_http_err_connect_fail_count", COUNTER, nullptr}},
  {"proxy.process.http.err_connect_fail_origin_server_bytes", {"proxy_process_http_err_connect_fail_origin_server_bytes", COUNTER, nullptr}},
  {"proxy.process.http.err_connect_fail_user_agent_bytes", {"proxy_process_http_err_connect_fail_user_agent_bytes", COUNTER, nullptr}},
  ...
  {"proxy.process.http.origin_connections_throttled_out", {"proxy_process_http_origin_connections_throttled_out", COUNTER, nullptr}},
  ...
  {"proxy.process.http.origin_server_request_document_total_size", {"proxy_process_http_origin_server_request_document_total_size", COUNTER, nullptr}},
  {"proxy.process.http.origin_server_request_header_total_size", {"proxy_process_http_origin_server_request_header_total_size", COUNTER, nullptr}},
  {"proxy.process.http.origin_server_response_document_total_size", {"proxy_process_http_origin_server_response_document_total_size", COUNTER, nullptr}},
  {"proxy.process.http.origin_server_response_header_total_size", {"proxy_process_http_origin_server_response_header_total_size", COUNTER, nullptr}},
  {"proxy.process.http.origin_shutdown.cleanup_entry", {"proxy_process_http_origin_shutdown_cleanup_entry", COUNTER, nullptr}},
  {"proxy.process.http.origin_shutdown.migration_failure", {"proxy_process_http_origin_shutdown_migration_failure", COUNTER, nullptr}},
  {"proxy.process.http.origin_shutdown.pool_lock_contention", {"proxy_process_http_origin_shutdown_pool_lock_contention", COUNTER, nullptr}},
  {"proxy.process.http.origin_shutdown.release_invalid_request", {"proxy_process_http_origin_shutdown_release_invalid_request", COUNTER, nullptr}},
  {"proxy.process.http.origin_shutdown.release_invalid_response", {"proxy_process_http_origin_shutdown_release_invalid_response", COUNTER, nullptr}},
  {"proxy.process.http.origin_shutdown.release_misc", {"proxy_process_http_origin_shutdown_release_misc", COUNTER, nullptr}},
  {"proxy.process.http.origin_shutdown.release_modified", {"proxy_process_http_origin_shutdown_release_modified", COUNTER, nullptr}},
  {"proxy.process.http.origin_shutdown.release_no_keep_alive", {"proxy_process_http_origin_shutdown_release_no_keep_alive", COUNTER, nullptr}},
  {"proxy.process.http.origin_shutdown.release_no_server", {"proxy_process_http_origin_shutdown_release_no_server", COUNTER, nullptr}},
  {"proxy.process.http.origin_shutdown.release_no_sharing", {"proxy_process_http_origin_shutdown_release_no_sharing", COUNTER, nullptr}},
  ...
  {"proxy.process.http.origin_shutdown.tunnel_server_detach", {"proxy_process_http_origin_shutdown_tunnel_server_detach", COUNTER, nullptr}},
  {"proxy.process.http.origin_shutdown.tunnel_server_eos", {"proxy_process_http_origin_shutdown_tunnel_server_eos", COUNTER, nullptr}},
  {"proxy.process.http.origin_shutdown.tunnel_server_no_keep_alive", {"proxy_process_http_origin_shutdown_tunnel_server_no_keep_alive", COUNTER, nullptr}},
  {"proxy.process.http.origin_shutdown.tunnel_server_plugin_tunnel", {"proxy_process_http_origin_shutdown_tunnel_server_plugin_tunnel", COUNTER, nullptr}},
  {"proxy.process.http.origin_shutdown.tunnel_transform_read", {"proxy_process_http_origin_shutdown_tunnel_transform_read", COUNTER, nullptr}},
  ...
  {"proxy.process.http.parent_proxy_request_total_bytes", {"proxy_process_http_parent_proxy_request_total_bytes", COUNTER, nullptr}},
  {"proxy.process.http.parent_proxy_response_total_bytes", {"proxy_process_http_parent_proxy_response_total_bytes", COUNTER, nullptr}},
  ...
  {"proxy.process.http.pushed_response_header_total_size", {"proxy_process_http_pushed_response_header_total_size", COUNTER, nullptr}},
  ...
  {"proxy.process.http.milestone.server_read_header_done", {"proxy_process_http_milestone_server_read_header_done", COUNTER, nullptr}},
  ...
  {"proxy.process.http.tcp_client_refresh_origin_server_bytes", {"proxy_process_http_tcp_client_refresh_origin_server_bytes", COUNTER, nullptr}},
  {"proxy.process.http.tcp_client_refresh_user_agent_bytes", {"proxy_process_http_tcp_client_refresh_user_agent_bytes", COUNTER, nullptr}},
  {"proxy.process.http.tcp_expired_miss_count", {"proxy_process_http_tcp_expired_miss_count", COUNTER, nullptr}},
  {"proxy.process.http.tcp_expired_miss_origin_server_bytes", {"proxy_process_http_tcp_expired_miss_origin_server_bytes", COUNTER, nullptr}},
  {"proxy.process.http.tcp_expired_miss_user_agent_bytes", {"proxy_process_http_tcp_expired_miss_user_agent_bytes", COUNTER, nullptr}},
  ...
  {"proxy.process.http.tcp_ims_miss_origin_server_bytes", {"proxy_process_http_tcp_ims_miss_origin_server_bytes", COUNTER, nullptr}},
  ...
  {"proxy.process.http.tcp_refresh_hit_origin_server_bytes", {"proxy_process_http_tcp_refresh_hit_origin_server_bytes", COUNTER, nullptr}},
  {"proxy.process.http.tcp_refresh_hit_user_agent_bytes", {"proxy_process_http_tcp_refresh_hit_user_agent_bytes", COUNTER, nullptr}},
  {"proxy.process.http.tcp_refresh_miss_count", {"proxy_process_http_tcp_refresh_miss_count", COUNTER, nullptr}},
  {"proxy.process.http.tcp_refresh_miss_origin_server_bytes", {"proxy_process_http_tcp_refresh_miss_origin_server_bytes", COUNTER, nullptr}},
  {"proxy.process.http.tcp_refresh_miss_user_agent_bytes", {"proxy_process_http_tcp_refresh_miss_user_agent_bytes", COUNTER, nullptr}},
  ...
  {"proxy.process.http.transaction_counts.errors.aborts", {"proxy_process_http_transaction_counts_errors_aborts", COUNTER, nullptr}},
  {"proxy.process.http.transaction_counts.errors.connect_failed", {"proxy_process_http_transaction_counts_errors_connect_failed", COUNTER, nullptr}},
  {"proxy.process.http.transaction_counts.errors.other", {"proxy_process_http_transaction_counts_errors_other", COUNTER, nullptr}},
  {"proxy.process.http.transaction_counts.errors.possible_aborts", {"proxy_process_http_transaction_counts_errors_possible_aborts", COUNTER, nullptr}},
  {"proxy.process.http.transaction_counts.errors.pre_accept_hangups", {"proxy_process_http_transaction_counts_errors_pre_accept_hangups", COUNTER, nullptr}},
  {"proxy.process.http.transaction_counts.hit_fresh", {"proxy_process_http_transaction_counts_hit_fresh", COUNTER, nullptr}},
  {"proxy.process.http.transaction_counts.hit_fresh.process", {"proxy_process_http_transaction_counts_hit_fresh_process", COUNTER, nullptr}},
  {"proxy.process.http.transaction_counts.hit_revalidated", {"proxy_process_http_transaction_counts_hit_revalidated", COUNTER, nullptr}},
  {"proxy.process.http.transaction_counts.miss_changed", {"proxy_process_http_transaction_counts_miss_changed", COUNTER, nullptr}},
  {"proxy.process.http.transaction_counts.miss_client_no_cache", {"proxy_process_http_transaction_counts_miss_client_no_cache", COUNTER, nullptr}},
  {"proxy.process.http.transaction_counts.miss_cold", {"proxy_process_http_transaction_counts_miss_cold", COUNTER, nullptr}},
  {"proxy.process.http.transaction_counts.miss_not_cacheable", {"proxy_process_http_transaction_counts_miss_not_cacheable", COUNTER, nullptr}},
  {"proxy.process.http.transaction_counts.other.unclassified", {"proxy_process_http_transaction_counts_other_unclassified", COUNTER, nullptr}},
  {"proxy.process.http.milestone.ua_first_read", {"proxy_process_http_milestone_ua_first_read", COUNTER, nullptr}},
  {"proxy.process.http.transaction_totaltime.errors.aborts", {"proxy_process_http_transaction_totaltime_errors_aborts", COUNTER, nullptr}},
  {"proxy.process.http.transaction_totaltime.errors.connect_failed", {"proxy_process_http_transaction_totaltime_errors_connect_failed", COUNTER, nullptr}},
  {"proxy.process.http.transaction_totaltime.errors.other", {"proxy_process_http_transaction_totaltime_errors_other", COUNTER, nullptr}},
  {"proxy.process.http.transaction_totaltime.errors.possible_aborts", {"proxy_process_http_transaction_totaltime_errors_possible_aborts", COUNTER, nullptr}},
  {"proxy.process.http.transaction_totaltime.errors.pre_accept_hangups", {"proxy_process_http_transaction_totaltime_errors_pre_accept_hangups", COUNTER, nullptr}},
  {"proxy.process.http.transaction_totaltime.hit_fresh", {"proxy_process_http_transaction_totaltime_hit_fresh", COUNTER, nullptr}},
  {"proxy.process.http.transaction_totaltime.hit_fresh.process", {"proxy_process_http_transaction_totaltime_hit_fresh_process", COUNTER, nullptr}},
  {"proxy.process.http.transaction_totaltime.hit_revalidated", {"proxy_process_http_transaction_totaltime_hit_revalidated", COUNTER, nullptr}},
  {"proxy.process.http.transaction_totaltime.miss_changed", {"proxy_process_http_transaction_totaltime_miss_changed", COUNTER, nullptr}},
  {"proxy.process.http.transaction_totaltime.miss_client_no_cache", {"proxy_process_http_transaction_totaltime_miss_client_no_cache", COUNTER, nullptr}},
  {"proxy.process.http.transaction_totaltime.miss_cold", {"proxy_process_http_transaction_totaltime_miss_cold", COUNTER, nullptr}},
  {"proxy.process.http.transaction_totaltime.miss_not_cacheable", {"proxy_process_http_transaction_totaltime_miss_not_cacheable", COUNTER, nullptr}},
  {"proxy.process.http.transaction_totaltime.other.unclassified", {"proxy_process_http_transaction_totaltime_other_unclassified", COUNTER, nullptr}},
  {"proxy.process.http.milestone.ua_read_header_done", {"proxy_process_http_milestone_ua_read_header_done", COUNTER, nullptr}},
  {"proxy.process.http.user_agent_request_document_total_size", {"proxy_process_http_user_agent_request_document_total_size", COUNTER, nullptr}},
  {"proxy.process.http.user_agent_request_header_total_size", {"proxy_process_http_user_agent_request_header_total_size", COUNTER, nullptr}},
  {"proxy.process.http.user_agent_response_document_total_size", {"proxy_process_http_user_agent_response_document_total_size", COUNTER, nullptr}},
  {"proxy.process.http.user_agent_response_header_total_size", {"proxy_process_http_user_agent_response_header_total_size", COUNTER, nullptr}},
  {"proxy.process.http.websocket.current_active_client_connections", {"proxy_process_http_websocket_current_active_client_connections", GAUGE, nullptr}},

  {"proxy.process.http.user_agent_total_request_bytes", {"proxy_process_http_user_agent_total_request_bytes", COUNTER, "Total bytes of client request body + headers"}},
  {"proxy.process.http.user_agent_total_response_bytes", {"proxy_process_http_user_agent_total_response_bytes", COUNTER, "Total bytes of client response body + headers"}},
  {"proxy.process.http.origin_server_total_request_bytes", {"proxy_process_http_origin_server_total_request_bytes", COUNTER, "Total bytes of origin server request body + headers"}},
  {"proxy.process.http.origin_server_total_response_bytes", {"proxy_process_http_origin_server_total_response_bytes", COUNTER, "Total bytes of origin server response body + headers"}},
  {"proxy.process.user_agent_total_bytes", {"proxy_process_user_agent_total_bytes", COUNTER, "Total bytes of client request and response (total traffic to and from clients)"}},
  {"proxy.process.origin_server_total_bytes", {"proxy_process_origin_server_total_bytes", COUNTER, "Total bytes of origin/parent request and response"}},
  ...
  {"proxy.process.current_server_connections", {"proxy_process_current_server_connections", GAUGE, "Total of all server connections (sum of origins and parent connections)"}},
  {"proxy.process.cache_total_requests", {"proxy_process_cache_total_requests", COUNTER, "Total requests, both hits and misses (this is slightly superfluous, but assures correct percentage calculations)"}},
  {"proxy.process.cache_total_hits_bytes", {"proxy_process_cache_total_hits_bytes", COUNTER, "Total cache requests bytes which are cache hits"}},
  {"proxy.process.cache_total_misses_bytes", {"proxy_process_cache_total_misses_bytes", COUNTER, "Total cache requests bytes which are cache misses"}},
  ...
  {"proxy.process.http2.current_active_client_connections", {"proxy_process_http2_current_active_client_connections", GAUGE, nullptr}},
  {"proxy.process.http2.current_active_server_connections", {"proxy_process_http2_current_active_server_connections", GAUGE, nullptr}},
  ...
  {"proxy.process.http2.max_settings_per_frame_exceeded", {"proxy_process_http2_max_settings_per_frame_exceeded", COUNTER, nullptr}},
  {"proxy.process.http2.max_settings_per_minute_exceeded", {"proxy_process_http2_max_settings_per_minute_exceeded", COUNTER, nullptr}},
  {"proxy.process.http2.max_settings_frames_per_minute_exceeded", {"proxy_process_http2_max_settings_frames_per_minute_exceeded", COUNTER, nullptr}},
  {"proxy.process.http2.max_ping_frames_per_minute_exceeded", {"proxy_process_http2_max_ping_frames_per_minute_exceeded", COUNTER, nullptr}},
  {"proxy.process.http2.max_priority_frames_per_minute_exceeded", {"proxy_process_http2_max_priority_frames_per_minute_exceeded", COUNTER, nullptr}},
  {"proxy.process.http2.max_rst_stream_frames_per_minute_exceeded", {"proxy_process_http2_max_rst_stream_frames_per_minute_exceeded", COUNTER, nullptr}},
  {"proxy.process.http2.max_continuation_frames_per_minute_exceeded", {"proxy_process_http2_max_continuation_frames_per_minute_exceeded", COUNTER, nullptr}},
  {"proxy.process.http2.max_empty_frames_per_minute_exceeded", {"proxy_process_http2_max_empty_frames_per_minute_exceeded", COUNTER, nullptr}},
  {"proxy.process.http2.insufficient_avg_window_update", {"proxy_process_http2_insufficient_avg_window_update", COUNTER, nullptr}},
  {"proxy.process.http2.max_concurrent_streams_exceeded_in", {"proxy_process_http2_max_concurrent_streams_exceeded_in", COUNTER, nullptr}},
  {"proxy.process.http2.max_concurrent_streams_exceeded_out", {"proxy_process_http2_max_concurrent_streams_exceeded_out", COUNTER, nullptr}},
  ...
  {"proxy.process.log.bytes_lost_before_sent_to_network", {"proxy_process_log_bytes_lost_before_sent_to_network", COUNTER, nullptr}},
  ...
  {"proxy.process.log.bytes_lost_before_written_to_disk", {"proxy_process_log_bytes_lost_before_written_to_disk", COUNTER, nullptr}},
...
#define APPEND_STAT_TEXT_PROMETHEUS(a, fmt, v)                                                                  \
  do {                                                                                                          \
    ...
    for (const char *p = a; *p; p++, q++) {                                                                     \
      char c = *p;                                                                                              \
      *q = (('a' <= c && c <= 'z') || ('A' <= c && c <= 'Z') || ('0' <= c && c <= '9') || c == '_' || c == ':') \
          ? c : '_';                                                                                            \
    }                                                                                                           \
    *q = '\0';                                                                                                  \
  ...
  do {                                                                                                            \
    ...
    if (it != prom_metric_info_map.end()) {                                                                       \
      ...
      *q = '\0';                                                                                                  \
      ...
      if (has_prefix_literal(a, API_TIME_PREFIX)                                                                  \
	  || has_prefix_literal(a, EVENTLOOP_PREFIX)                                                              \
	  || has_prefix_literal(a, SSL_CIPHER_USER_AGENT_PREFIX))                                                 \
        type = COUNTER;                                                                                           \
    }                                                                                                             \
    if (help != nullptr) {                                                                                        \
      if (snprintf(b, sizeof(b), "# HELP %s\n# TYPE %s %s\n%s " fmt "\n", help,                                   \
...
{
  const char *version;
  TSRecordDump((TSRecordType)(TS_RECORDTYPE_PLUGIN | TS_RECORDTYPE_NODE | TS_RECORDTYPE_PROCESS), text_prometheus_out_stat, my_state);
...
#if HAVE_BROTLI_ENCODE_H
    else if (len >= TS_HTTP_LEN_BROTLI && strstr(str, TS_HTTP_VALUE_BROTLI) != nullptr && my_state->output != TEXT_PROMETHEUS_OUTPUT) {
