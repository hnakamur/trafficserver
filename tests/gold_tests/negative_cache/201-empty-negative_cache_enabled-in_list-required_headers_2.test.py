'''
Test negative cache 201 empty response with negative_caching_enabled=1, in list and required_headers=2
'''
...
tr.Processes.Default.Streams.stdout = "gold/201-cache_fill.gold"
