'''
Test negative cache 400 with negative_caching_enabled=1 and not in list
'''
...
testName = ""
request_header1 = {"headers": "GET /400 HTTP/1.1\r\nHost: www.example.com\r\n\r\n", "timestamp": "1469733493.993", "body": ""}
response_header1 = {"headers": "HTTP/1.1 400 Bad Request\r\nContent-Length: 3\r\nConnection: close\r\n\r\n", "timestamp": "1469733493.993", "body": "yyy"}
...
# Test 1 - 400 non empty response and cache miss
tr = Test.AddTestRun()
