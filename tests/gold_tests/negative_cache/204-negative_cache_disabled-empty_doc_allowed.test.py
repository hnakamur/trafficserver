'''
Test negative cache 204 empty response with negative_caching_enabled=0 and allow_empty_doc=1
'''
...
tr.Processes.Default.Streams.stdout = "gold/204-no-cache-fill.gold"
