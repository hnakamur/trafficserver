...
class Test_remap_acl:
    ...
    def __init__(
        ...
        tr = Test_remap_acl.Test.AddTestRun(name)
    ...
    def _configure_client(self, tr: 'TestRun') -> None:
        ...
        if self._expected_responses == [None, None]:
            ...
            self._ts.Disk.diags_log.Content += Test_remap_acl.Testers.ContainsExpression(
            ...
            p.Streams.stdout += Test_remap_acl.Testers.ContainsExpression(
