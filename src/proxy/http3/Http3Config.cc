...
{
  RecEstablishStaticConfigUInt32("proxy.config.http3.header_table_size", &this->_header_table_size);
  RecEstablishStaticConfigUInt32("proxy.config.http3.max_field_section_size", &this->_max_field_section_size);
  RecEstablishStaticConfigUInt32("proxy.config.http3.qpack_blocked_streams", &this->_qpack_blocked_streams);
  RecEstablishStaticConfigUInt32("proxy.config.http3.num_placeholders", &this->_num_placeholders);
  RecEstablishStaticConfigUInt32("proxy.config.http3.max_settings", &this->_max_settings);
}
