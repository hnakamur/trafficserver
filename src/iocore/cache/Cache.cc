...
ink_cache_init(ts::ModuleVersion v)
{
  ...
  RecEstablishStaticConfigInt("proxy.config.cache.ram_cache.size", &cache_config_ram_cache_size);
  ...
  RecEstablishStaticConfigInt("proxy.config.cache.ram_cache_cutoff", &cache_config_ram_cache_cutoff);
