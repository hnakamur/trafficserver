...
{
  RecEstablishStaticConfigUInt32("proxy.config.quic.instance_id", &this->_instance_id);
  RecEstablishStaticConfigInt32("proxy.config.quic.connection_table.size", &this->_connection_table_size);
  RecEstablishStaticConfigUInt32("proxy.config.quic.server.stateless_retry_enabled", &this->_stateless_retry);
  RecEstablishStaticConfigUInt32("proxy.config.quic.client.vn_exercise_enabled", &this->_vn_exercise_enabled);
  RecEstablishStaticConfigUInt32("proxy.config.quic.client.cm_exercise_enabled", &this->_cm_exercise_enabled);
  ...
  if (auto [rec_str, err]{RecGetRecordStringAlloc("proxy.config.quic.preferred_address_ipv4")}; err == REC_ERR_OKAY) {
    this->_preferred_address_ipv4 = rec_str;
  }
  ...
  if (auto [rec_str, err]{RecGetRecordStringAlloc("proxy.config.quic.preferred_address_ipv6")}; err == REC_ERR_OKAY) {
    this->_preferred_address_ipv6 = rec_str;
  }
  if (this->_preferred_address_ipv6) {
    ats_ip_pton(this->_preferred_address_ipv6, &this->_preferred_endpoint_ipv6);
  }
  RecEstablishStaticConfigUInt32("proxy.config.quic.initial_max_data_in", &this->_initial_max_data_in);
  RecEstablishStaticConfigUInt32("proxy.config.quic.initial_max_data_out", &this->_initial_max_data_out);
  ...
  RecEstablishStaticConfigUInt32("proxy.config.quic.initial_max_stream_data_uni_in", &this->_initial_max_stream_data_uni_in);
  RecEstablishStaticConfigUInt32("proxy.config.quic.initial_max_stream_data_uni_out", &this->_initial_max_stream_data_uni_out);
  RecEstablishStaticConfigUInt32("proxy.config.quic.initial_max_streams_bidi_in", &this->_initial_max_streams_bidi_in);
  RecEstablishStaticConfigUInt32("proxy.config.quic.initial_max_streams_bidi_out", &this->_initial_max_streams_bidi_out);
  RecEstablishStaticConfigUInt32("proxy.config.quic.initial_max_streams_uni_in", &this->_initial_max_streams_uni_in);
  RecEstablishStaticConfigUInt32("proxy.config.quic.initial_max_streams_uni_out", &this->_initial_max_streams_uni_out);
  RecEstablishStaticConfigUInt32("proxy.config.quic.ack_delay_exponent_in", &this->_ack_delay_exponent_in);
  RecEstablishStaticConfigUInt32("proxy.config.quic.ack_delay_exponent_out", &this->_ack_delay_exponent_out);
  RecEstablishStaticConfigUInt32("proxy.config.quic.max_ack_delay_in", &this->_max_ack_delay_in);
  RecEstablishStaticConfigUInt32("proxy.config.quic.max_ack_delay_out", &this->_max_ack_delay_out);
  RecEstablishStaticConfigUInt32("proxy.config.quic.active_cid_limit_in", &this->_active_cid_limit_in);
  RecEstablishStaticConfigUInt32("proxy.config.quic.active_cid_limit_out", &this->_active_cid_limit_out);
  RecEstablishStaticConfigUInt32("proxy.config.quic.disable_active_migration", &this->_disable_active_migration);
  RecEstablishStaticConfigUInt32("proxy.config.quic.max_recv_udp_payload_size_in", &this->_max_recv_udp_payload_size_in);
  RecEstablishStaticConfigUInt32("proxy.config.quic.max_recv_udp_payload_size_out", &this->_max_recv_udp_payload_size_out);
  RecEstablishStaticConfigUInt32("proxy.config.quic.max_send_udp_payload_size_in", &this->_max_send_udp_payload_size_in);
  RecEstablishStaticConfigUInt32("proxy.config.quic.max_send_udp_payload_size_out", &this->_max_send_udp_payload_size_out);
  RecEstablishStaticConfigUInt32("proxy.config.quic.disable_http_0_9", &this->_disable_http_0_9);
  RecEstablishStaticConfigUInt32("proxy.config.quic.cc_algorithm", &this->_cc_algorithm);
